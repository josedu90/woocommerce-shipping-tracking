	...
	public static function get_company_url($trackurl,$trackno, $shipping_postcode = '')
	{
		...
		$urltrack = null;
			if ($trackurl == 'VIETNAMPOST'){
				...
				$urltrack = 'https://www.chilexpress.cl/Views/ChilexpressCL/Resultado-busqueda.aspx?DATA='.$trackno;;
			}
			else if ($trackurl == 'STARKEN'){
				$urltrack = 'http://www.starken.cl/seguimiento?codigo='.$trackno;
			}
				...
				$urltrack = 'https://www.internationalparceltracking.com/Main.aspx#/track/'.$trackno.'/BE/'.$shipping_postcode;
			}
				...
				//$urltrack = 'https://www.postnord.se/online-verktyg/verktyg/sok/spara-brev-paket-och-pall?trackntraceAction=saveSearch&lang=GB&consignmentId=RR315265118EE#dynamicloading=true&shipmentid='.$trackno;
				...
				//$urltrack = 'https://track.aftership.com/estafeta/'.$trackno;
				...
				//$urltrack = 'http://websro.correios.com.br/sro_bin/txect01$.Inexistente?P_LINGUA=001&P_TIPO=002&P_COD_LIS='.$trackno; //old
				//$urltrack = 'http://www2.correios.com.br/sistemas/rastreamento/'; //new
				...
				$urltrack = 'https://www.correos.cl/SitePages/seguimiento/seguimiento.aspx?envio='.$trackno;
			}
