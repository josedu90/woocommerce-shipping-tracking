...
class WCST_BulkImport
{
	...
	public function render_page()
	{
		...
		<div class="wcst_wrap white-box">
			...
			<h2 class="wcst_section_title wcst_small_margin_top"><?php _e('Import tracking info', 'woocommerce-shipping-tracking');?></h2>
			
			<div id="instruction-box">
				<div id="description">
					<h3><?php _e('Select a .csv file that has the following columns:','woocommerce-shipping-tracking');?></h3>
					<ul id="field_list">
							<li>order_id</li>
				...
				<div class="option_selector_container">
					<label><?php _e('In case an order already has some tracking info associated, merge the existing info with imported data?', 'woocommerce-shipping-tracking');?></label>
				...
				<div class="option_selector_container">
					<label><?php _e('Select a file', 'woocommerce-shipping-tracking');?></label>
